 ...
 * @author andre
 */
public class ItemResponse extends javax.swing.JFrame {

    /**
     * Creates new form ItemResponse
     */
    public ItemResponse() {
        initComponents();
    }
    ...
    public ItemResponse(PharmacyItem item) {
        ...
        this.setTitle("Proveedor "+item.getProviderName());
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Confirmación del Pedido");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemResponse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ItemResponse().setVisible(true);
            }
        });
    }
